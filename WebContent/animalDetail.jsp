...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<%
				AnimalBbsDto animalDto = (AnimalBbsDto)request.getAttribute("animalDto");
			...
			<div class="table-responsive">
				<table border="1" id="myTable">
					...
					<tr>
						<th>Location.</th>
						<td>${animalDto.location }</td>
					</tr>
					<tr>
						<th>Medicine.</th>
						<td>${animalDto.medicine }</td>
					</tr>
					<tr>
						<th>Neutralization.</th>
						<td>${animalDto.neutralization }</td>
					</tr>
					<tr>
						<th>Gender.</th>
					...
					<tr>
						<th>Pic1.</th>
						<td>${animalDto.pic1 }</td>
					</tr>
					<tr>
						<th>UserSeq.</th>
						<td>${animalDto.userSeq }</td>
					</tr>
					<tr>
						<th>Contact.</th>
					...
					<tr>
						<th>Readcount.</th>
						<td>${animalDto.readcount }</td>
					</tr>					
					<tr>
						<th>User_email.</th>
						<td>${animalDto.user_email }</td>
					</tr>
					<tr>
						<th>Content.</th>
