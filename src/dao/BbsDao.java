...
public class BbsDao {
	...
	public List<CommuBbsDto> getAllCommuBbs() {
		...
		String sql = " SELECT a.seq, a.pic1, a.target_category, a.TITLE as title, a.content, target_user_seq, READCOUNT, a.reg_date as reg_date, a.last_update as last_update, a.del, b.title as category_name, c.email as user_email  "
